...
extern UART_HandleTypeDef hlpuart1;       /* Mcu dependent UART handler */
extern UART_HandleTypeDef huart3;       /* Mcu dependent UART handler */
extern TIM_HandleTypeDef htim2;         /* Mcu dependent TIM handler */
extern TIM_HandleTypeDef htim5;         /* Mcu dependent TIM handler */

#define CS_PIN GPIO_PIN_14              /* Mcu dependent chip select */
#define GPIO_PORT GPIOD    /* Mcu dependent adc chip select port */
#endif
...
void adBmsWakeupIcTim(uint8_t total_ic);
